...
namespace FarseerPhysics.Collision
{
    ...
    public struct AABB
    {
        ...
        {
            get { return new Vector2((LowerBound.X + UpperBound.X) * 0.5f, (LowerBound.Y + UpperBound.Y) * 0.5f); }
        }
        ...
        {
            get { return new Vector2((UpperBound.X - LowerBound.X) * 0.5f, (UpperBound.Y - LowerBound.Y) * 0.5f); }
        }
        ...
        public static bool TestOverlap(AABB a, AABB b)
        {
            ...
            return TestOverlapFast(ref a, ref b);
        }

        public static bool TestOverlapFast(ref AABB a, ref AABB b)
        {
            return !(b.LowerBound.X - a.UpperBound.X > 0 || 
        ...
        public static bool TestOverlap(ref AABB a, ref AABB b)
        {
            ...
            //Garry: faster version without intermediary structs
            return !(b.LowerBound.X - a.UpperBound.X > 0 ||
                b.LowerBound.Y - a.UpperBound.Y > 0 ||
                a.LowerBound.X - b.UpperBound.X > 0 ||
                a.LowerBound.Y - b.UpperBound.Y > 0);
